    ...
    <div class="mb-4">
      <div class="flex gap-2 overflow-auto no-scrollbar">
        <button
          ...
          :key="status.value"
          class="px-4 py-2 rounded-full text-sm border shadow-sm whitespace-nowrap transition-colors cursor-pointer"
    ...
    <div class="space-y-3">
      ...
      >
        ...
        >
          ...
          <!-- 정산일 -->
          <div v-if="payment.status === 'completed'">
            <p class="text-xs text-gray-500 dark:text-gray-400 text-right">정산일</p>
        ...
        <button
          ...
          class="mt-3 w-full py-2 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm cursor-pointer"
        >
          상세 보기
        </button>
      </div>
